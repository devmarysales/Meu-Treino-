  ...
  weeks: [
    { num:1, title:'Semana 1', phase:'Adaptação neuromuscular', days:[
      { id:'w1d1', label:'Seg', name:'Inferior A', type:'inf', exercises:[
        { id:'e1', name:'Agachamento livre', sets:3, reps:'12–15', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e2', name:'Leg press 45°', sets:3, reps:'12–15', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e3', name:'Cadeira extensora', sets:3, reps:'15', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e4', name:'Cadeira flexora', sets:3, reps:'12–15', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e5', name:'Panturrilha em pé', sets:4, reps:'20', rest:'45s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
      ]},
      { id:'w1d2', label:'Ter', name:'Superior A — Empurrar', type:'sup', exercises:[
        { id:'e6', name:'Supino reto com barra', sets:3, reps:'12–15', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e7', name:'Desenvolvimento com halteres', sets:3, reps:'12–15', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e8', name:'Crossover na polia', sets:3, reps:'15', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e9', name:'Tríceps corda na polia', sets:3, reps:'15', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e10', name:'Elevação lateral', sets:3, reps:'15–20', rest:'45s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
      ]},
      { id:'w1d3', label:'Qua', name:'Inferior B', type:'inf', exercises:[
        { id:'e11', name:'Stiff com barra', sets:3, reps:'12', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e12', name:'Avanço com halteres', sets:3, reps:'12 cada', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e13', name:'Hip thrust com barra', sets:4, reps:'12–15', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e14', name:'Adução na máquina', sets:3, reps:'15–20', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e15', name:'Abdominal supra', sets:3, reps:'20', rest:'45s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
      ]},
      { id:'w1d4', label:'Qui', name:'Superior B — Puxar', type:'sup', exercises:[
        { id:'e16', name:'Puxada frontal na polia', sets:3, reps:'12–15', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e17', name:'Remada baixa na polia', sets:3, reps:'12–15', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e18', name:'Remada unilateral c/ halter', sets:3, reps:'12 cada', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e19', name:'Rosca direta com barra', sets:3, reps:'12–15', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e20', name:'Rosca concentrada', sets:3, reps:'12 cada', rest:'45s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
      ]},
      { id:'w1d5', label:'Sex', name:'Full Body', type:'full', exercises:[
        { id:'e21', name:'Levantamento terra', sets:3, reps:'10–12', rest:'90s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e22', name:'Supino inclinado c/ halteres', sets:3, reps:'12', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e23', name:'Agachamento goblet', sets:3, reps:'15', rest:'60s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e24', name:'Remada curvada com barra', sets:3, reps:'12', rest:'75s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e25', name:'Prancha isométrica', sets:3, reps:'30–45s', rest:'45s', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
      ]},
      { id:'w1d6', label:'Sáb', name:'Descanso ativo', type:'rest', exercises:[
        { id:'e26', name:'Caminhada leve', sets:1, reps:'20–30 min', rest:'—', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
        { id:'e27', name:'Foam roller + mobilidade', sets:1, reps:'15 min', rest:'—', mods:['Iniciante: ','Intermediário: ','Avançado:'] },
      ]},
    ]},
